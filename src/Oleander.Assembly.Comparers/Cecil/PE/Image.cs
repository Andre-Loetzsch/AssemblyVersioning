...
namespace Oleander.Assembly.Comparers.Cecil.PE {
	...
	sealed class Image {
		...
		/*Telerik Authorship*/
		public int TimeDateStampPosition;
		...
		{
			var section = this.GetSectionAtVirtualAddress (this.Debug.VirtualAddress);
			var buffer = new ByteBuffer (section.Data);
			buffer.position = (int) (this.Debug.VirtualAddress - section.VirtualAddress);
