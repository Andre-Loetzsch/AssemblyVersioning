        ...
        public FrameworkVersion GetFrameworkVersionForModule(ModuleDefinition module)
        {
            ...
            switch (platform)
            {
                ...
                case TargetPlatform.NetCore:
                    return this.GetFrameworkVersionInternal(module, TargetPlatform.NetCore);
                case TargetPlatform.WinRT:
                    return this.GetFrameworkVersionInternal(module, TargetPlatform.WinRT);
                case TargetPlatform.Xamarin:
                    return this.GetFrameworkVersionInternal(module, TargetPlatform.Xamarin);
